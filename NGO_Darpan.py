...
exepath="C:/Users/sawanta/OneDrive - Dun and Bradstreet/Desktop/chromedriver.exe"
...
try:
    for states in stlist:
        ...
        driver.get(url)
        time.sleep(1)
        classnm=driver.find_elements_by_xpath('//*[@id="frm_griev"]/table[2]/tbody/tr[2]/td/table/tbody/tr[5]/td/ol/li[1]/a').click()
        state=driver.find_element_by_partial_link_text(states)
        state.click()
        time.sleep(3)
        view=driver.find_element_by_xpath('/html/body/div[9]/div[1]/div[3]/div/div/div[1]/form/div[2]/select')
        view.send_keys("100")
...
wb=pd.ExcelWriter("C:/Users/sawanta/OneDrive - Dun and Bradstreet/Desktop/NGO_DARPAN/NGO_DARPAN_ANDAMAN NICOBAR_July2022_output."+dte+".xlsx")
